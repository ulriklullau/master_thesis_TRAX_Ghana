...
Compressor.specific_cycle_1(
    p_11=70.52/2,  # power level for the first operation segment
    t_11=420,
    p_12=70.52/2,
...
Compressor.specific_cycle_2(p_21=80.75/2, t_21=120, r_c2=0.1)

# third cycle: intermediate cycle
Compressor.specific_cycle_3(p_31=86.95/2, t_31=480, r_c3=0.1)
...
Fan.specific_cycle_1(p_11=26.60/4, t_11=420, p_12=12, t_12=420, r_c1=0.1)
Fan.specific_cycle_2(p_21=29.98/4, t_21=120, r_c2=0.1)
Fan.specific_cycle_3(p_31=32.70/4, t_31=480, r_c3=0.1)
...
Lamp = CS.add_appliance(
    ...
    num_windows=1,  # Number of time-windows the appliance is used in
    time_fraction_random_variability = 0.2  # 20% randomness assigned to the size of the functioning windows
)
...
# %%
# Save the full year profile to a CSV file
Profiles_series.to_csv("load_profile_full_year.csv", header=True)